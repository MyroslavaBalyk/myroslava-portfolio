...
const Footer = () => {
  return (
    <footer className="w-full py-8 px-6 md:px-12 lg:px-24 bg-gray-100 dark:bg-gray-800">
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Column 1 */}
          <div>
            <h3 className="text-lg font-semibold mb-4 text-gray-800 dark:text-white">Myroslava</h3>
            <p className="text-gray-600 dark:text-gray-300 mb-4">
              Building beautiful and functional web experiences.
            </p>
            <div className="flex space-x-4">
              <a href="https://github.com/yourusername" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
                <svg className="w-5 h-5 text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-2">Email: your.email@example.com</p>
            <p className="text-gray-600 dark:text-gray-300">Location: Your City, Country</p>
          </div>
        </div>
